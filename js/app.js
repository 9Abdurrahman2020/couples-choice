...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="card  shadow-sm pt-3" id="card">
    <img src="${image}" class="card-img-top mx-auto" alt="..." style="width: 150px; height:150px;">
    <div class="card-body text-center">
      ...
      <button onclick="addToCart(${product.price})" class="btn btn-outline-secondary">add to card</button>

      <button onclick="singleProductData(${product.id})" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModal">Details</button>
    </div>
  </div>`;
...
const singleProductData=id=>{
  ...
  fetch(url).then(res=>res.json()).then(data=>displayModalDetail(data))
}
// show detail while click on details 
...
div.innerHTML = `<div class="card border-0 text-center">
